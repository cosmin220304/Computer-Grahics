...
{
public:
	void sierpinskiCarpet(double lungime, int nivel, CPunct p)
	{
		double x, y;
		p.getxy(x, y);
		...
		if (nivel == 0)
		{
			drawSquare(lungime, p);
		}
		else
		{
			drawSquare(lungime, p);
			sierpinskiCarpet(lungime / 3, nivel - 1, CPunct(x, y + lungime * 2));
			sierpinskiCarpet(lungime / 3, nivel - 1, CPunct(x, y - lungime * 2));
			sierpinskiCarpet(lungime / 3, nivel - 1, CPunct(x + lungime * 2, y));
			sierpinskiCarpet(lungime / 3, nivel - 1, CPunct(x - lungime * 2, y));
			sierpinskiCarpet(lungime / 3, nivel - 1, CPunct(x + lungime * 2, y + lungime * 2));
			sierpinskiCarpet(lungime / 3, nivel - 1, CPunct(x + lungime * 2, y - lungime * 2));
			sierpinskiCarpet(lungime / 3, nivel - 1, CPunct(x - lungime * 2, y + lungime * 2));
			sierpinskiCarpet(lungime / 3, nivel - 1, CPunct(x - lungime * 2, y - lungime * 2));
		}
	...
	void afisare(double lungime, int nivel)
	{
		...
		sierpinskiCarpet(lungime, nivel, CPunct(0, 0));
	}
};
